...
# parameters
# 
add_parameter N_PORTS INTEGER 4
set_parameter_property N_PORTS DEFAULT_VALUE 4
set_parameter_property N_PORTS DISPLAY_NAME N_PORTS
set_parameter_property N_PORTS TYPE INTEGER
set_parameter_property N_PORTS UNITS None
set_parameter_property N_PORTS ALLOWED_RANGES -2147483648:2147483647
...
add_parameter IDX_WIDTH INTEGER 2
set_parameter_property IDX_WIDTH DEFAULT_VALUE 2
set_parameter_property IDX_WIDTH DISPLAY_NAME IDX_WIDTH
set_parameter_property IDX_WIDTH TYPE INTEGER
set_parameter_property IDX_WIDTH UNITS None
set_parameter_property IDX_WIDTH ALLOWED_RANGES -2147483648:2147483647
set_parameter_property IDX_WIDTH HDL_PARAMETER true
...
add_interface_port ingress_port_0 ingress_port_0_tdata tdata Input "((DATA_WIDTH-1)) - (0) + 1"
...
add_interface_port ingress_port_0 ingress_port_0_tdest tdest Input "((IDX_WIDTH-1)) - (0) + 1"
...
add_interface_port ingress_port_1 ingress_port_1_tdata tdata Input "((DATA_WIDTH-1)) - (0) + 1"
...
add_interface_port ingress_port_1 ingress_port_1_tdest tdest Input "((IDX_WIDTH-1)) - (0) + 1"
...
add_interface_port ingress_port_2 ingress_port_2_tdata tdata Input "((DATA_WIDTH-1)) - (0) + 1"
...
add_interface_port ingress_port_2 ingress_port_2_tdest tdest Input "((IDX_WIDTH-1)) - (0) + 1"
...
add_interface_port ingress_port_3 ingress_port_3_tdata tdata Input "((DATA_WIDTH-1)) - (0) + 1"
...
add_interface_port ingress_port_3 ingress_port_3_tdest tdest Input "((IDX_WIDTH-1)) - (0) + 1"
...
add_interface_port egress_port_0 egress_port_0_tdata tdata Output "((DATA_WIDTH-1)) - (0) + 1"
...
add_interface_port egress_port_1 egress_port_1_tdata tdata Output "((DATA_WIDTH-1)) - (0) + 1"
...
add_interface_port egress_port_2 egress_port_2_tdata tdata Output "((DATA_WIDTH-1)) - (0) + 1"
...
add_interface_port egress_port_3 egress_port_3_tdata tdata Output "((DATA_WIDTH-1)) - (0) + 1"
